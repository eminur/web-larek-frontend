...
Архитектура приложения спроектирована с использованием паттерна MVP
...
Объединяет части заказа, данные условии оплаты и адреса доставки, контактные данные заказа. Позволяет записывать и получать значения условии оплаты заказа, записывать и получать контактные данные, выполнять проверку валидности записываемых данных
...
-   **\'item:addbasket\'** - добавление товара в корзину, на вход передается идентификатор товара
